...
set ID 143
set hasByteEnable 0
set MemName calcLayerDetAndTrfYi
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_det0_V \
    op interface \
    ports { det0_V_din { O 32 vector } det0_V_full_n { I 1 bit } det0_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_det1_V3 \
    op interface \
    ports { det1_V3_din { O 32 vector } det1_V3_full_n { I 1 bit } det1_V3_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_det2_V6 \
    op interface \
    ports { det2_V6_din { O 32 vector } det2_V6_full_n { I 1 bit } det2_V6_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sum_V \
    op interface \
    ports { sum_V_dout { I 32 vector } sum_V_empty_n { I 1 bit } sum_V_read { O 1 bit } } \
} "
}
