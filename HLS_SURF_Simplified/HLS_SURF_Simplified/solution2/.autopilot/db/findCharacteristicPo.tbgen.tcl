...
set C_modelArgList {
	{ det0_V float 32 regular {fifo 0 volatile }  }
	{ det1_V3 float 32 regular {fifo 0 volatile }  }
	{ det2_V6 float 32 regular {fifo 0 volatile }  }
	{ keyPoints_V int 32 regular {axi_master 1}  }
	{ pointNumber int 32 regular {axi_master 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "det0_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "det1_V3", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "det2_V6", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ det0_V_dout sc_in sc_lv 32 signal 0 } 
	{ det0_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ det0_V_read sc_out sc_logic 1 signal 0 } 
	{ det1_V3_dout sc_in sc_lv 32 signal 1 } 
	{ det1_V3_empty_n sc_in sc_logic 1 signal 1 } 
	{ det1_V3_read sc_out sc_logic 1 signal 1 } 
	{ det2_V6_dout sc_in sc_lv 32 signal 2 } 
	{ det2_V6_empty_n sc_in sc_logic 1 signal 2 } 
	{ det2_V6_read sc_out sc_logic 1 signal 2 } 
	{ m_axi_keyPoints_V_AWVALID sc_out sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_AWREADY sc_in sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_AWADDR sc_out sc_lv 32 signal 3 } 
	{ m_axi_keyPoints_V_AWID sc_out sc_lv 1 signal 3 } 
	{ m_axi_keyPoints_V_AWLEN sc_out sc_lv 32 signal 3 } 
	{ m_axi_keyPoints_V_AWSIZE sc_out sc_lv 3 signal 3 } 
	{ m_axi_keyPoints_V_AWBURST sc_out sc_lv 2 signal 3 } 
	{ m_axi_keyPoints_V_AWLOCK sc_out sc_lv 2 signal 3 } 
	{ m_axi_keyPoints_V_AWCACHE sc_out sc_lv 4 signal 3 } 
	{ m_axi_keyPoints_V_AWPROT sc_out sc_lv 3 signal 3 } 
	{ m_axi_keyPoints_V_AWQOS sc_out sc_lv 4 signal 3 } 
	{ m_axi_keyPoints_V_AWREGION sc_out sc_lv 4 signal 3 } 
	{ m_axi_keyPoints_V_AWUSER sc_out sc_lv 1 signal 3 } 
	{ m_axi_keyPoints_V_WVALID sc_out sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_WREADY sc_in sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_WDATA sc_out sc_lv 32 signal 3 } 
	{ m_axi_keyPoints_V_WSTRB sc_out sc_lv 4 signal 3 } 
	{ m_axi_keyPoints_V_WLAST sc_out sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_WID sc_out sc_lv 1 signal 3 } 
	{ m_axi_keyPoints_V_WUSER sc_out sc_lv 1 signal 3 } 
	{ m_axi_keyPoints_V_ARVALID sc_out sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_ARREADY sc_in sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_ARADDR sc_out sc_lv 32 signal 3 } 
	{ m_axi_keyPoints_V_ARID sc_out sc_lv 1 signal 3 } 
	{ m_axi_keyPoints_V_ARLEN sc_out sc_lv 32 signal 3 } 
	{ m_axi_keyPoints_V_ARSIZE sc_out sc_lv 3 signal 3 } 
	{ m_axi_keyPoints_V_ARBURST sc_out sc_lv 2 signal 3 } 
	{ m_axi_keyPoints_V_ARLOCK sc_out sc_lv 2 signal 3 } 
	{ m_axi_keyPoints_V_ARCACHE sc_out sc_lv 4 signal 3 } 
	{ m_axi_keyPoints_V_ARPROT sc_out sc_lv 3 signal 3 } 
	{ m_axi_keyPoints_V_ARQOS sc_out sc_lv 4 signal 3 } 
	{ m_axi_keyPoints_V_ARREGION sc_out sc_lv 4 signal 3 } 
	{ m_axi_keyPoints_V_ARUSER sc_out sc_lv 1 signal 3 } 
	{ m_axi_keyPoints_V_RVALID sc_in sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_RREADY sc_out sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_RDATA sc_in sc_lv 32 signal 3 } 
	{ m_axi_keyPoints_V_RLAST sc_in sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_RID sc_in sc_lv 1 signal 3 } 
	{ m_axi_keyPoints_V_RUSER sc_in sc_lv 1 signal 3 } 
	{ m_axi_keyPoints_V_RRESP sc_in sc_lv 2 signal 3 } 
	{ m_axi_keyPoints_V_BVALID sc_in sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_BREADY sc_out sc_logic 1 signal 3 } 
	{ m_axi_keyPoints_V_BRESP sc_in sc_lv 2 signal 3 } 
	{ m_axi_keyPoints_V_BID sc_in sc_lv 1 signal 3 } 
	{ m_axi_keyPoints_V_BUSER sc_in sc_lv 1 signal 3 } 
	{ m_axi_pointNumber_AWVALID sc_out sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_AWREADY sc_in sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_AWADDR sc_out sc_lv 32 signal 4 } 
	{ m_axi_pointNumber_AWID sc_out sc_lv 1 signal 4 } 
	{ m_axi_pointNumber_AWLEN sc_out sc_lv 32 signal 4 } 
	{ m_axi_pointNumber_AWSIZE sc_out sc_lv 3 signal 4 } 
	{ m_axi_pointNumber_AWBURST sc_out sc_lv 2 signal 4 } 
	{ m_axi_pointNumber_AWLOCK sc_out sc_lv 2 signal 4 } 
	{ m_axi_pointNumber_AWCACHE sc_out sc_lv 4 signal 4 } 
	{ m_axi_pointNumber_AWPROT sc_out sc_lv 3 signal 4 } 
	{ m_axi_pointNumber_AWQOS sc_out sc_lv 4 signal 4 } 
	{ m_axi_pointNumber_AWREGION sc_out sc_lv 4 signal 4 } 
	{ m_axi_pointNumber_AWUSER sc_out sc_lv 1 signal 4 } 
	{ m_axi_pointNumber_WVALID sc_out sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_WREADY sc_in sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_WDATA sc_out sc_lv 32 signal 4 } 
	{ m_axi_pointNumber_WSTRB sc_out sc_lv 4 signal 4 } 
	{ m_axi_pointNumber_WLAST sc_out sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_WID sc_out sc_lv 1 signal 4 } 
	{ m_axi_pointNumber_WUSER sc_out sc_lv 1 signal 4 } 
	{ m_axi_pointNumber_ARVALID sc_out sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_ARREADY sc_in sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_ARADDR sc_out sc_lv 32 signal 4 } 
	{ m_axi_pointNumber_ARID sc_out sc_lv 1 signal 4 } 
	{ m_axi_pointNumber_ARLEN sc_out sc_lv 32 signal 4 } 
	{ m_axi_pointNumber_ARSIZE sc_out sc_lv 3 signal 4 } 
	{ m_axi_pointNumber_ARBURST sc_out sc_lv 2 signal 4 } 
	{ m_axi_pointNumber_ARLOCK sc_out sc_lv 2 signal 4 } 
	{ m_axi_pointNumber_ARCACHE sc_out sc_lv 4 signal 4 } 
	{ m_axi_pointNumber_ARPROT sc_out sc_lv 3 signal 4 } 
	{ m_axi_pointNumber_ARQOS sc_out sc_lv 4 signal 4 } 
	{ m_axi_pointNumber_ARREGION sc_out sc_lv 4 signal 4 } 
	{ m_axi_pointNumber_ARUSER sc_out sc_lv 1 signal 4 } 
	{ m_axi_pointNumber_RVALID sc_in sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_RREADY sc_out sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_RDATA sc_in sc_lv 32 signal 4 } 
	{ m_axi_pointNumber_RLAST sc_in sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_RID sc_in sc_lv 1 signal 4 } 
	{ m_axi_pointNumber_RUSER sc_in sc_lv 1 signal 4 } 
	{ m_axi_pointNumber_RRESP sc_in sc_lv 2 signal 4 } 
	{ m_axi_pointNumber_BVALID sc_in sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_BREADY sc_out sc_logic 1 signal 4 } 
	{ m_axi_pointNumber_BRESP sc_in sc_lv 2 signal 4 } 
	{ m_axi_pointNumber_BID sc_in sc_lv 1 signal 4 } 
	{ m_axi_pointNumber_BUSER sc_in sc_lv 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "det0_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "det0_V", "role": "dout" }} , 
 	{ "name": "det0_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "det0_V", "role": "empty_n" }} , 
 	{ "name": "det0_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "det0_V", "role": "read" }} , 
 	{ "name": "det1_V3_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "det1_V3", "role": "dout" }} , 
 	{ "name": "det1_V3_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "det1_V3", "role": "empty_n" }} , 
 	{ "name": "det1_V3_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "det1_V3", "role": "read" }} , 
 	{ "name": "det2_V6_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "det2_V6", "role": "dout" }} , 
 	{ "name": "det2_V6_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "det2_V6", "role": "empty_n" }} , 
 	{ "name": "det2_V6_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "det2_V6", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			{"Name" : "det0_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "det0_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "det1_V3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "det1_V3_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "det2_V6", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.N1_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.surfDetector_fcmpGfk_U148", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.surfDetector_mul_Hfu_U149", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1404223", "Max" : "30855526"}
	, {"Name" : "Interval", "Min" : "1404223", "Max" : "30855526"}
]}
...
set Spec2ImplPortList { 
	det0_V { ap_fifo {  { det0_V_dout fifo_data 0 32 }  { det0_V_empty_n fifo_status 0 1 }  { det0_V_read fifo_update 1 1 } } }
	det1_V3 { ap_fifo {  { det1_V3_dout fifo_data 0 32 }  { det1_V3_empty_n fifo_status 0 1 }  { det1_V3_read fifo_update 1 1 } } }
	det2_V6 { ap_fifo {  { det2_V6_dout fifo_data 0 32 }  { det2_V6_empty_n fifo_status 0 1 }  { det2_V6_read fifo_update 1 1 } } }
