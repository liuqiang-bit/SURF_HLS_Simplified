...
architecture behav of HessianDetector is 
    ...
    signal calcLayerDetAndTrace_U0_det0_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal calcLayerDetAndTrace_U0_det0_V_write : STD_LOGIC;
    signal calcLayerDetAndTrace_U0_det1_V3_din : STD_LOGIC_VECTOR (31 downto 0);
    signal calcLayerDetAndTrace_U0_det1_V3_write : STD_LOGIC;
    signal calcLayerDetAndTrace_U0_det2_V6_din : STD_LOGIC_VECTOR (31 downto 0);
    signal calcLayerDetAndTrace_U0_det2_V6_write : STD_LOGIC;
    ...
    signal findCharacteristicPo_U0_det0_V_read : STD_LOGIC;
    signal findCharacteristicPo_U0_det1_V3_read : STD_LOGIC;
    signal findCharacteristicPo_U0_det2_V6_read : STD_LOGIC;
    ...
    signal dets_0_V_full_n : STD_LOGIC;
    signal dets_0_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal dets_0_V_empty_n : STD_LOGIC;
    signal dets_1_V_full_n : STD_LOGIC;
    signal dets_1_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal dets_1_V_empty_n : STD_LOGIC;
    signal dets_2_V_full_n : STD_LOGIC;
    signal dets_2_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal dets_2_V_empty_n : STD_LOGIC;
    ...
    port (
        ...
        det0_V_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        det0_V_full_n : IN STD_LOGIC;
        det0_V_write : OUT STD_LOGIC;
        det1_V3_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        det1_V3_full_n : IN STD_LOGIC;
        det1_V3_write : OUT STD_LOGIC;
        det2_V6_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        det2_V6_full_n : IN STD_LOGIC;
        det2_V6_write : OUT STD_LOGIC;
        sum_V_dout : IN STD_LOGIC_VECTOR (31 downto 0);
        sum_V_empty_n : IN STD_LOGIC;
        sum_V_read : OUT STD_LOGIC );
    end component;
    ...
    component start_for_findChaIfE IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    dets_0_V_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    dets_1_V_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    dets_2_V_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_findChaIfE_U : component start_for_findChaIfE
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
