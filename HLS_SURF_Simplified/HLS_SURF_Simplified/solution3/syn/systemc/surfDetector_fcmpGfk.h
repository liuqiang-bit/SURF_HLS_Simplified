...
// ==============================================================
#ifndef __surfDetector_fcmpGfk__HH__
#define __surfDetector_fcmpGfk__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(surfDetector_fcmpGfk) {
    ...
    SC_CTOR(surfDetector_fcmpGfk):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
