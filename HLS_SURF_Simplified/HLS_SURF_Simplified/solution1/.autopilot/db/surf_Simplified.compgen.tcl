...
set InstName img_data_stream_0_V_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 88
set FifoName fifo_w8_d2_A
set InstName img_data_stream_1_V_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 89
set FifoName fifo_w8_d2_A
set InstName img_data_stream_2_V_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 91
set FifoName fifo_w32_d3_A
set InstName this_assign_1_loc_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 92
set FifoName start_for_HessianxdS
set InstName start_for_HessianxdS_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 93
set FifoName start_for_integrayd2
set InstName start_for_integrayd2_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 94 \
			corename surf_Simplified_AXILiteS_axilite \
			name surf_Simplified_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler surf_Simplified_AXILiteS_s_axi
}
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 95 \
			corename surf_Simplified_threshold_axilite \
			name surf_Simplified_threshold_s_axi \
			ports {$port_threshold} \
			op interface \
			is_flushable 0 \ 
		} "
	} else {
		puts "@W \[IMPL-110\] Cannot find AXI Lite interface model in the library. Ignored generation of AXI Lite  interface for 'threshold'"
	}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler surf_Simplified_threshold_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 8.75 \ 
    is_flushable 0 \ 
    name {surf_Simplified_keyPoints_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'keyPoints'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler surf_Simplified_keyPoints_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 8.75 \ 
    is_flushable 0 \ 
    name {surf_Simplified_pointNumber_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'pointNumber'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler surf_Simplified_pointNumber_m_axi
}
