...
set ID 63
set hasByteEnable 0
set MemName findCharacteristiudo
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_det0_V_V \
    op interface \
    ports { det0_V_V_dout { I 32 vector } det0_V_V_empty_n { I 1 bit } det0_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_det1_V_V3 \
    op interface \
    ports { det1_V_V3_dout { I 32 vector } det1_V_V3_empty_n { I 1 bit } det1_V_V3_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_det2_V_V6 \
    op interface \
    ports { det2_V_V6_dout { I 32 vector } det2_V_V6_empty_n { I 1 bit } det2_V_V6_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 67 \
    name hessianThreshold_V \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_hessianThreshold_V \
    op interface \
    ports { hessianThreshold_V_dout { I 32 vector } hessianThreshold_V_empty_n { I 1 bit } hessianThreshold_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 69 \
    name keyPoints_V_offset \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_keyPoints_V_offset \
    op interface \
    ports { keyPoints_V_offset_dout { I 32 vector } keyPoints_V_offset_empty_n { I 1 bit } keyPoints_V_offset_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 71 \
    name pointNumber_offset \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_pointNumber_offset \
    op interface \
    ports { pointNumber_offset_dout { I 32 vector } pointNumber_offset_empty_n { I 1 bit } pointNumber_offset_read { O 1 bit } } \
} "
}
