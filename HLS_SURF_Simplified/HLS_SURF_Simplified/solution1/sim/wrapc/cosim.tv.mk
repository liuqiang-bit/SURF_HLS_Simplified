# ==============================================================
# File generated on Thu Aug 27 15:07:14 +0800 2020
...
$(ObjDir)/mSURF.cpp_pre.cpp.tb.o : mSURF.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling mSURF.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
