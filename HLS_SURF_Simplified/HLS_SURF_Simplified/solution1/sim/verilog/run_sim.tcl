...
if {[file isfile surf_Simplified.autotvin.dat]} {
	file delete -force surf_Simplified.autotvin.dat
}

if {[file isfile surf_Simplified.autotvout.dat]} {
	file delete -force surf_Simplified.autotvout.dat
}
