...
## Variables
set Top "surf_Simplified"
set TopNoPrefix "surf_Simplified"
...
set Interfaces {
    ...
    s_axi_threshold {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_threshold"
        param_prefix "C_S_AXI_THRESHOLD"
        addr_bits "5"
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {{0x10 threshold W 0x0 "Data signal of threshold" {{0 32 threshold W 0 "Bit 31 to 0 Data signal of threshold"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_threshold m_axi_keyPoints m_axi_pointNumber video_in"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_keyPoints {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_keyPoints"
        data_width "32"
        param_prefix "C_M_AXI_KEYPOINTS"
    ...
    m_axi_pointNumber {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_pointNumber"
        data_width "32"
        param_prefix "C_M_AXI_POINTNUMBER"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 5296622 II x}
