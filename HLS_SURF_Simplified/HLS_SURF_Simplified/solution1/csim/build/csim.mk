...
HLS_SOURCES = ../../../../test.cpp ../../../../top.cpp ../../../../mSURF.cpp
...
$(ObjDir)/mSURF.o: ../../../../mSURF.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../mSURF.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/mSURF.d
