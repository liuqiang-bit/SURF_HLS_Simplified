...
HessianDetector::HessianDetector(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    calcLayerDetAndTrace_U0->det0_V_V_din(calcLayerDetAndTrace_U0_det0_V_V_din);
    calcLayerDetAndTrace_U0->det0_V_V_full_n(dets_0_V_V_full_n);
    calcLayerDetAndTrace_U0->det0_V_V_write(calcLayerDetAndTrace_U0_det0_V_V_write);
    calcLayerDetAndTrace_U0->det1_V_V3_din(calcLayerDetAndTrace_U0_det1_V_V3_din);
    calcLayerDetAndTrace_U0->det1_V_V3_full_n(dets_1_V_V_full_n);
    calcLayerDetAndTrace_U0->det1_V_V3_write(calcLayerDetAndTrace_U0_det1_V_V3_write);
    calcLayerDetAndTrace_U0->det2_V_V6_din(calcLayerDetAndTrace_U0_det2_V_V6_din);
    calcLayerDetAndTrace_U0->det2_V_V6_full_n(dets_2_V_V_full_n);
    calcLayerDetAndTrace_U0->det2_V_V6_write(calcLayerDetAndTrace_U0_det2_V_V6_write);
    calcLayerDetAndTrace_U0->this_assign_1_reload_dout(this_assign_1_loc_dout);
    calcLayerDetAndTrace_U0->this_assign_1_reload_empty_n(this_assign_1_loc_empty_n);
    calcLayerDetAndTrace_U0->this_assign_1_reload_read(calcLayerDetAndTrace_U0_this_assign_1_reload_read);
    calcLayerDetAndTrace_U0->this_assign_1_reload_out_din(calcLayerDetAndTrace_U0_this_assign_1_reload_out_din);
    calcLayerDetAndTrace_U0->this_assign_1_reload_out_full_n(this_assign_1_reload_full_n);
    calcLayerDetAndTrace_U0->this_assign_1_reload_out_write(calcLayerDetAndTrace_U0_this_assign_1_reload_out_write);
    calcLayerDetAndTrace_U0->keyPoints_V_offset_dout(keyPoints_V_offset_dout);
    calcLayerDetAndTrace_U0->keyPoints_V_offset_empty_n(keyPoints_V_offset_empty_n);
    calcLayerDetAndTrace_U0->keyPoints_V_offset_read(calcLayerDetAndTrace_U0_keyPoints_V_offset_read);
    calcLayerDetAndTrace_U0->pointNumber_offset_dout(pointNumber_offset_dout);
    calcLayerDetAndTrace_U0->pointNumber_offset_empty_n(pointNumber_offset_empty_n);
    calcLayerDetAndTrace_U0->pointNumber_offset_read(calcLayerDetAndTrace_U0_pointNumber_offset_read);
    calcLayerDetAndTrace_U0->keyPoints_V_offset_out_din(calcLayerDetAndTrace_U0_keyPoints_V_offset_out_din);
    calcLayerDetAndTrace_U0->keyPoints_V_offset_out_full_n(keyPoints_V_offset_c_full_n);
    calcLayerDetAndTrace_U0->keyPoints_V_offset_out_write(calcLayerDetAndTrace_U0_keyPoints_V_offset_out_write);
    calcLayerDetAndTrace_U0->pointNumber_offset_out_din(calcLayerDetAndTrace_U0_pointNumber_offset_out_din);
    calcLayerDetAndTrace_U0->pointNumber_offset_out_full_n(pointNumber_offset_c_full_n);
    calcLayerDetAndTrace_U0->pointNumber_offset_out_write(calcLayerDetAndTrace_U0_pointNumber_offset_out_write);
    ...
    findCharacteristicPo_U0->det0_V_V_dout(dets_0_V_V_dout);
    findCharacteristicPo_U0->det0_V_V_empty_n(dets_0_V_V_empty_n);
    findCharacteristicPo_U0->det0_V_V_read(findCharacteristicPo_U0_det0_V_V_read);
    findCharacteristicPo_U0->det1_V_V3_dout(dets_1_V_V_dout);
    findCharacteristicPo_U0->det1_V_V3_empty_n(dets_1_V_V_empty_n);
    findCharacteristicPo_U0->det1_V_V3_read(findCharacteristicPo_U0_det1_V_V3_read);
    findCharacteristicPo_U0->det2_V_V6_dout(dets_2_V_V_dout);
    findCharacteristicPo_U0->det2_V_V6_empty_n(dets_2_V_V_empty_n);
    findCharacteristicPo_U0->det2_V_V6_read(findCharacteristicPo_U0_det2_V_V6_read);
    findCharacteristicPo_U0->hessianThreshold_V_dout(this_assign_1_reload_dout);
    findCharacteristicPo_U0->hessianThreshold_V_empty_n(this_assign_1_reload_empty_n);
    findCharacteristicPo_U0->hessianThreshold_V_read(findCharacteristicPo_U0_hessianThreshold_V_read);
    ...
    findCharacteristicPo_U0->keyPoints_V_offset_dout(keyPoints_V_offset_c_dout);
    findCharacteristicPo_U0->keyPoints_V_offset_empty_n(keyPoints_V_offset_c_empty_n);
    findCharacteristicPo_U0->keyPoints_V_offset_read(findCharacteristicPo_U0_keyPoints_V_offset_read);
    ...
    findCharacteristicPo_U0->pointNumber_offset_dout(pointNumber_offset_c_dout);
    findCharacteristicPo_U0->pointNumber_offset_empty_n(pointNumber_offset_c_empty_n);
    findCharacteristicPo_U0->pointNumber_offset_read(findCharacteristicPo_U0_pointNumber_offset_read);
    dets_0_V_V_U = new fifo_w32_d2_A("dets_0_V_V_U");
    dets_0_V_V_U->clk(ap_clk);
    dets_0_V_V_U->reset(ap_rst);
    dets_0_V_V_U->if_read_ce(ap_var_for_const4);
    dets_0_V_V_U->if_write_ce(ap_var_for_const4);
    dets_0_V_V_U->if_din(calcLayerDetAndTrace_U0_det0_V_V_din);
    dets_0_V_V_U->if_full_n(dets_0_V_V_full_n);
    dets_0_V_V_U->if_write(calcLayerDetAndTrace_U0_det0_V_V_write);
    dets_0_V_V_U->if_dout(dets_0_V_V_dout);
    dets_0_V_V_U->if_empty_n(dets_0_V_V_empty_n);
    dets_0_V_V_U->if_read(findCharacteristicPo_U0_det0_V_V_read);
    dets_1_V_V_U = new fifo_w32_d2_A("dets_1_V_V_U");
    dets_1_V_V_U->clk(ap_clk);
    dets_1_V_V_U->reset(ap_rst);
    dets_1_V_V_U->if_read_ce(ap_var_for_const4);
    dets_1_V_V_U->if_write_ce(ap_var_for_const4);
    dets_1_V_V_U->if_din(calcLayerDetAndTrace_U0_det1_V_V3_din);
    dets_1_V_V_U->if_full_n(dets_1_V_V_full_n);
    dets_1_V_V_U->if_write(calcLayerDetAndTrace_U0_det1_V_V3_write);
    dets_1_V_V_U->if_dout(dets_1_V_V_dout);
    dets_1_V_V_U->if_empty_n(dets_1_V_V_empty_n);
    dets_1_V_V_U->if_read(findCharacteristicPo_U0_det1_V_V3_read);
    dets_2_V_V_U = new fifo_w32_d2_A("dets_2_V_V_U");
    dets_2_V_V_U->clk(ap_clk);
    dets_2_V_V_U->reset(ap_rst);
    dets_2_V_V_U->if_read_ce(ap_var_for_const4);
    dets_2_V_V_U->if_write_ce(ap_var_for_const4);
    dets_2_V_V_U->if_din(calcLayerDetAndTrace_U0_det2_V_V6_din);
    dets_2_V_V_U->if_full_n(dets_2_V_V_full_n);
    dets_2_V_V_U->if_write(calcLayerDetAndTrace_U0_det2_V_V6_write);
    dets_2_V_V_U->if_dout(dets_2_V_V_dout);
    dets_2_V_V_U->if_empty_n(dets_2_V_V_empty_n);
    dets_2_V_V_U->if_read(findCharacteristicPo_U0_det2_V_V6_read);
    this_assign_1_reload_U = new fifo_w32_d2_A("this_assign_1_reload_U");
    this_assign_1_reload_U->clk(ap_clk);
    this_assign_1_reload_U->reset(ap_rst);
    this_assign_1_reload_U->if_read_ce(ap_var_for_const4);
    this_assign_1_reload_U->if_write_ce(ap_var_for_const4);
    this_assign_1_reload_U->if_din(calcLayerDetAndTrace_U0_this_assign_1_reload_out_din);
    this_assign_1_reload_U->if_full_n(this_assign_1_reload_full_n);
    this_assign_1_reload_U->if_write(calcLayerDetAndTrace_U0_this_assign_1_reload_out_write);
    this_assign_1_reload_U->if_dout(this_assign_1_reload_dout);
    this_assign_1_reload_U->if_empty_n(this_assign_1_reload_empty_n);
    this_assign_1_reload_U->if_read(findCharacteristicPo_U0_hessianThreshold_V_read);
    keyPoints_V_offset_c_U = new fifo_w32_d2_A("keyPoints_V_offset_c_U");
    keyPoints_V_offset_c_U->clk(ap_clk);
    keyPoints_V_offset_c_U->reset(ap_rst);
    keyPoints_V_offset_c_U->if_read_ce(ap_var_for_const4);
    keyPoints_V_offset_c_U->if_write_ce(ap_var_for_const4);
    keyPoints_V_offset_c_U->if_din(calcLayerDetAndTrace_U0_keyPoints_V_offset_out_din);
    keyPoints_V_offset_c_U->if_full_n(keyPoints_V_offset_c_full_n);
    keyPoints_V_offset_c_U->if_write(calcLayerDetAndTrace_U0_keyPoints_V_offset_out_write);
    keyPoints_V_offset_c_U->if_dout(keyPoints_V_offset_c_dout);
    keyPoints_V_offset_c_U->if_empty_n(keyPoints_V_offset_c_empty_n);
    keyPoints_V_offset_c_U->if_read(findCharacteristicPo_U0_keyPoints_V_offset_read);
    pointNumber_offset_c_U = new fifo_w32_d2_A("pointNumber_offset_c_U");
    pointNumber_offset_c_U->clk(ap_clk);
    pointNumber_offset_c_U->reset(ap_rst);
    pointNumber_offset_c_U->if_read_ce(ap_var_for_const4);
    pointNumber_offset_c_U->if_write_ce(ap_var_for_const4);
    pointNumber_offset_c_U->if_din(calcLayerDetAndTrace_U0_pointNumber_offset_out_din);
    pointNumber_offset_c_U->if_full_n(pointNumber_offset_c_full_n);
    pointNumber_offset_c_U->if_write(calcLayerDetAndTrace_U0_pointNumber_offset_out_write);
    pointNumber_offset_c_U->if_dout(pointNumber_offset_c_dout);
    pointNumber_offset_c_U->if_empty_n(pointNumber_offset_c_empty_n);
    pointNumber_offset_c_U->if_read(findCharacteristicPo_U0_pointNumber_offset_read);
    start_for_findChawdI_U = new start_for_findChawdI("start_for_findChawdI_U");
    start_for_findChawdI_U->clk(ap_clk);
    start_for_findChawdI_U->reset(ap_rst);
    start_for_findChawdI_U->if_read_ce(ap_var_for_const4);
    start_for_findChawdI_U->if_write_ce(ap_var_for_const4);
    start_for_findChawdI_U->if_din(start_for_findCharacteristicPo_U0_din);
    start_for_findChawdI_U->if_full_n(start_for_findCharacteristicPo_U0_full_n);
    start_for_findChawdI_U->if_write(calcLayerDetAndTrace_U0_start_write);
    start_for_findChawdI_U->if_dout(start_for_findCharacteristicPo_U0_dout);
    start_for_findChawdI_U->if_empty_n(start_for_findCharacteristicPo_U0_empty_n);
    start_for_findChawdI_U->if_read(findCharacteristicPo_U0_ap_ready);
    ...
    sensitive << ( calcLayerDetAndTrace_U0_keyPoints_V_offset_read );
    ...
    sensitive << ( calcLayerDetAndTrace_U0_pointNumber_offset_read );
    ...
    SC_METHOD(thread_this_assign_1_loc_read);
    sensitive << ( calcLayerDetAndTrace_U0_this_assign_1_reload_read );
    ...
    sc_trace(mVcdFile, this_assign_1_loc_dout, "(port)this_assign_1_loc_dout");
    sc_trace(mVcdFile, this_assign_1_loc_empty_n, "(port)this_assign_1_loc_empty_n");
    sc_trace(mVcdFile, this_assign_1_loc_read, "(port)this_assign_1_loc_read");
    ...
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_det0_V_V_din, "calcLayerDetAndTrace_U0_det0_V_V_din");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_det0_V_V_write, "calcLayerDetAndTrace_U0_det0_V_V_write");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_det1_V_V3_din, "calcLayerDetAndTrace_U0_det1_V_V3_din");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_det1_V_V3_write, "calcLayerDetAndTrace_U0_det1_V_V3_write");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_det2_V_V6_din, "calcLayerDetAndTrace_U0_det2_V_V6_din");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_det2_V_V6_write, "calcLayerDetAndTrace_U0_det2_V_V6_write");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_this_assign_1_reload_read, "calcLayerDetAndTrace_U0_this_assign_1_reload_read");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_this_assign_1_reload_out_din, "calcLayerDetAndTrace_U0_this_assign_1_reload_out_din");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_this_assign_1_reload_out_write, "calcLayerDetAndTrace_U0_this_assign_1_reload_out_write");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_keyPoints_V_offset_read, "calcLayerDetAndTrace_U0_keyPoints_V_offset_read");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_pointNumber_offset_read, "calcLayerDetAndTrace_U0_pointNumber_offset_read");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_keyPoints_V_offset_out_din, "calcLayerDetAndTrace_U0_keyPoints_V_offset_out_din");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_keyPoints_V_offset_out_write, "calcLayerDetAndTrace_U0_keyPoints_V_offset_out_write");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_pointNumber_offset_out_din, "calcLayerDetAndTrace_U0_pointNumber_offset_out_din");
    sc_trace(mVcdFile, calcLayerDetAndTrace_U0_pointNumber_offset_out_write, "calcLayerDetAndTrace_U0_pointNumber_offset_out_write");
    ...
    sc_trace(mVcdFile, findCharacteristicPo_U0_det0_V_V_read, "findCharacteristicPo_U0_det0_V_V_read");
    sc_trace(mVcdFile, findCharacteristicPo_U0_det1_V_V3_read, "findCharacteristicPo_U0_det1_V_V3_read");
    sc_trace(mVcdFile, findCharacteristicPo_U0_det2_V_V6_read, "findCharacteristicPo_U0_det2_V_V6_read");
    sc_trace(mVcdFile, findCharacteristicPo_U0_hessianThreshold_V_read, "findCharacteristicPo_U0_hessianThreshold_V_read");
    ...
    sc_trace(mVcdFile, findCharacteristicPo_U0_keyPoints_V_offset_read, "findCharacteristicPo_U0_keyPoints_V_offset_read");
    ...
    sc_trace(mVcdFile, findCharacteristicPo_U0_pointNumber_offset_read, "findCharacteristicPo_U0_pointNumber_offset_read");
    sc_trace(mVcdFile, ap_sync_continue, "ap_sync_continue");
    sc_trace(mVcdFile, dets_0_V_V_full_n, "dets_0_V_V_full_n");
    sc_trace(mVcdFile, dets_0_V_V_dout, "dets_0_V_V_dout");
    sc_trace(mVcdFile, dets_0_V_V_empty_n, "dets_0_V_V_empty_n");
    sc_trace(mVcdFile, dets_1_V_V_full_n, "dets_1_V_V_full_n");
    sc_trace(mVcdFile, dets_1_V_V_dout, "dets_1_V_V_dout");
    sc_trace(mVcdFile, dets_1_V_V_empty_n, "dets_1_V_V_empty_n");
    sc_trace(mVcdFile, dets_2_V_V_full_n, "dets_2_V_V_full_n");
    sc_trace(mVcdFile, dets_2_V_V_dout, "dets_2_V_V_dout");
    sc_trace(mVcdFile, dets_2_V_V_empty_n, "dets_2_V_V_empty_n");
    sc_trace(mVcdFile, this_assign_1_reload_full_n, "this_assign_1_reload_full_n");
    sc_trace(mVcdFile, this_assign_1_reload_dout, "this_assign_1_reload_dout");
    sc_trace(mVcdFile, this_assign_1_reload_empty_n, "this_assign_1_reload_empty_n");
    sc_trace(mVcdFile, keyPoints_V_offset_c_full_n, "keyPoints_V_offset_c_full_n");
    sc_trace(mVcdFile, keyPoints_V_offset_c_dout, "keyPoints_V_offset_c_dout");
    sc_trace(mVcdFile, keyPoints_V_offset_c_empty_n, "keyPoints_V_offset_c_empty_n");
    sc_trace(mVcdFile, pointNumber_offset_c_full_n, "pointNumber_offset_c_full_n");
    sc_trace(mVcdFile, pointNumber_offset_c_dout, "pointNumber_offset_c_dout");
    sc_trace(mVcdFile, pointNumber_offset_c_empty_n, "pointNumber_offset_c_empty_n");
...
HessianDetector::~HessianDetector() {
    ...
    delete dets_1_V_V_U;
    delete dets_2_V_V_U;
    delete this_assign_1_reload_U;
    delete keyPoints_V_offset_c_U;
    delete pointNumber_offset_c_U;
    delete start_for_findChawdI_U;
}
...
void HessianDetector::thread_keyPoints_V_offset_read() {
    keyPoints_V_offset_read = calcLayerDetAndTrace_U0_keyPoints_V_offset_read.read();
}
...
void HessianDetector::thread_pointNumber_offset_read() {
    pointNumber_offset_read = calcLayerDetAndTrace_U0_pointNumber_offset_read.read();
}
...
void HessianDetector::thread_this_assign_1_loc_read() {
    this_assign_1_loc_read = calcLayerDetAndTrace_U0_this_assign_1_reload_read.read();
}
