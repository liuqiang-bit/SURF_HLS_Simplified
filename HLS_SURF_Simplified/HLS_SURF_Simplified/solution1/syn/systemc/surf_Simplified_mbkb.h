...
// ==============================================================
#ifndef __surf_Simplified_mbkb__HH__
#define __surf_Simplified_mbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(surf_Simplified_mbkb) {
    ...
    SC_CTOR(surf_Simplified_mbkb):  ACMP_smul_su_U ("ACMP_smul_su_U") {
