...
// ==============================================================
#ifndef __surf_Simplified_mtde__HH__
#define __surf_Simplified_mtde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(surf_Simplified_mtde) {
    ...
    SC_CTOR(surf_Simplified_mtde):  ACMP_smul_us_U ("ACMP_smul_us_U") {
