...
write_loop:for (int en = 0; en < nTotalLayers; en++)
{
	if (write_en[en])
	{
		...
		case 0:
		{
			switch (en) {
			case 0:
				memcpy(detA0_o + offset[en], det0Buf, detCol[en] << 2);
				break;
			case 1:
				memcpy(detA1_o + offset[en], det1Buf, detCol[en] << 2);
				break;
			case 2:
				memcpy(detA2_o + offset[en], det2Buf, detCol[en] << 2);
				break;
			default:
				break;
			}
		...
		case 1:
		{
			switch (en) {
			case 0:
				memcpy(detB0_o + offset[en], det0Buf, detCol[en] << 2);
				break;
			case 1:
				memcpy(detB1_o + offset[en], det1Buf, detCol[en] << 2);
				break;
			case 2:
				memcpy(detB2_o + offset[en], det2Buf, detCol[en] << 2);
				break;
			default:
				break;
			}
		...
		case 2:
		{
			switch (en) {
			case 0:
				memcpy(detC0_o + offset[en], det0Buf, detCol[en] << 2);
				break;
			case 1:
				memcpy(detC1_o + offset[en], det1Buf, detCol[en] << 2);
				break;
			case 2:
				memcpy(detC2_o + offset[en], det2Buf, detCol[en] << 2);
				break;
			default:
				break;
			}
...
findCharacteristicPoint_r0:for (int r = 0; r < detRow[midIndex - 1]; r++)
{
	...
	switch (indexr) {
	case 0:
		memcpy(&N1[0][rIndex][0], detA0_i + offset[0], detCol[0] << 2);
		break;
	case 1:
		memcpy(&N1[0][rIndex][0], detB0_i + offset[0], detCol[0] << 2);
		break;
	case 2:
		memcpy(&N1[0][rIndex][0], detC0_i + offset[0], detCol[0] << 2);
		break;
	default:
		break;
	}
	...
	if (r >= margin && r < detRow[midIndex] + margin)
	{
		switch (indexr) {
		case 0:
			memcpy(&N1[1][rIndex][margin], detA1_i + offset[1], detCol[1] << 2);
			break;
		case 1:
			memcpy(&N1[1][rIndex][margin], detB1_i + offset[1], detCol[1] << 2);
			break;
		case 2:
			memcpy(&N1[1][rIndex][margin], detC1_i + offset[1], detCol[1] << 2);
			break;
		default:
			break;
		}
	...
	if (r >= maxMargin && r < detRow[midIndex + 1] + maxMargin)
	{
		switch (indexr) {
		case 0:
			memcpy(&N1[2][rIndex][maxMargin], detA2_i + offset[2], detCol[2] << 2);
			break;
		case 1:
			memcpy(&N1[2][rIndex][maxMargin], detB2_i + offset[2], detCol[2] << 2);
			break;
		case 2:
			memcpy(&N1[2][rIndex][maxMargin], detC2_i + offset[2], detCol[2] << 2);
			break;
		default:
			break;
		}
